...
import across.samples.bpapi.BookPublisherApplication;
...
@WebAppConfiguration
@SpringBootTest(classes = { BookPublisherApplication.class, MockMvcConfiguration.class })
@ActiveProfiles("integration-test")
@ContextConfiguration(initializers = MockAcrossServletContextInitializer.class)
public class ITBookPublisherApplication
{
	@Autowired
